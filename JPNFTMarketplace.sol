...
contract JPNFTMarketplace is Ownable, ReentrancyGuard {
    IJPNFTFactory private immutable jpNFTFactory;
    ...
    constructor(
        ...
        IJPNFTFactory _jpNFTFactory
    ) {
        require(_platformFee <= 10000, "can't more than 10 percent");
        platformFee = _platformFee;
        feeRecipient = _feeRecipient;
        jpNFTFactory = _jpNFTFactory;
    }

    modifier isJPNFT(address _nft) {
        require(jpNFTFactory.isJPNFT(_nft), "not JP NFT");
        _;
    }
    ...
    function createSell(
        ...
        address _payToken,
        uint256 _price
    ) external isJPNFT(_nft) isPayableToken(_payToken) {
    ...
    function buy(
        ...
        IJPNFT nft = IJPNFT(listedNft.nft);
    ...
    function completeBid(address _nft, uint256 _tokenId) external {
        ...
        IJPNFT JPNft = IJPNFT(_nft);
        address royaltyRecipient = JPNft.getRoyaltyRecipient();
        uint256 royaltyFee = JPNft.getRoyaltyFee();
