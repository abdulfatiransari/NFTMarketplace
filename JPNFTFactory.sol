...
contract JPNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
...
contract JPNFTFactory {
    ...
    function isJPNFT(address _nft) external view returns (bool) {
        return _jpNFT[_nft];
    }
}
